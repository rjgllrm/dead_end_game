This file contains the core logic for Dead End Game, a first-person zombie shooter built using Python and Pygame and its source code. It handles everything from initializing the game window and assets to running the main game loop. Key features include:

Procedural map generation with walls, enemies, and exit conditions

Raycasting and floorcasting rendering engine for 3D-like visuals

HUD and UI overlays, including health, splash screens, and pause menu

Weapon and enemy systems, with animations, damage, and AI behavior

Audio integration with SFX and looping battle music

Dynamic difficulty and level progression with multiple enemy types

This is the entry point for launching the game, and it ties together all assets, input handling, rendering, and gameplay mechanics.



CREDITS TO FINFET ON YOUTUBE
